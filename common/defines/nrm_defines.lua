...
NDefines.NAir.DISRUPTION_FACTOR_CARRIER = 48

NDefines.NNavy.MAX_SUBMARINES_PER_AUTO_TASK_FORCE = 15
...
NDefines.NNavy.COMBAT_DAMAGE_TO_STR_FACTOR = 0.6
...
NDefines.NNavy.MISSION_MAX_REGIONS = 0
...
NDefines.NNavy.CARRIER_STACK_PENALTY = 16
...
NDefines.NNavy.NAVAL_MINES_ENCRYPTION_VS_DECRYPTION_FACTOR = 0.2
...
NDefines.NNavy.DEPTH_CHARGES_HIT_CHANCE_MULT = 0.2
...
NDefines.NNavy.CONVOY_DEFENSE_MAX_CONVOY_TO_SHIP_RATIO = 10.0
NDefines.NNavy.CONVOY_DEFENSE_MAX_REGION_TO_TASKFORCE_RATIO	= 1.3
NDefines.NNavy.SUBMARINE_REVEAL_BASE_CHANCE = 0.04
NDefines.NNavy.SUBMARINE_BASE_TORPEDO_REVEAL_CHANCE = 0.08
...
NDefines.NAI.PRODUCTION_MAX_PROGRESS_TTO_SWITCH_NAVAL = 0.02
